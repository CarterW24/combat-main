...
/// <summary>
/// Server -> client (opcode 98, sub 2). Reply to <see cref="ClientPathRequestPacket"/>. Wire format from
...
public class ClientPathReplyPacket : ClientPathBasePacket, ISerializablePacket
{
    ...
    /// <summary>1 = breadcrumb follower path (the "Take Me There" trail).</summary>
    public int ResultType = 1;

    /// <summary>Echoes the request id.</summary>
    public int RequestId;

    /// <summary>The path waypoints (start -> destination). Each drawn as a green trail node.</summary>
